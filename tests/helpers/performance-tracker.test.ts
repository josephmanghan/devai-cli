...
describe('PerformanceTracker', () => {
  ...
  it('handles errors in timeOperation correctly', async () => {
    ...
    await expect(tracker.timeOperation('failing-operation', errorFunction)).rejects.toThrow('Test error');
  ...
  it('tracks active operations correctly', () => {
    ...
    expect(tracker.getActiveOperations()).toEqual(expect.arrayContaining(['active-op-1', 'active-op-2']));
